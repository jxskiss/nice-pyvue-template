# -*- coding:utf-8 -*-
"""
For the convenient dotenv things, there are two dotenv library "django-dotenv"
and "python-dotenv" which all install itself as "dotenv" but not compatible,
and there is always something missing for each of them, what a shit!

Stop thinking which "dotenv" is the imported library, just use ourselves.
This module is copied from django-dotenv 1.4.1 and python-dotenv 0.7.1.
"""
...
def find_dotenv(filename='.env', raise_error_if_not_found=True, usecwd=False):
    """
